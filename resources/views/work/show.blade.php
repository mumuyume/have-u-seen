...
@php $currentStatus = $work->impressions->first()?->status ?? null; @endphp
...
<div class="inline-flex rounded-lg overflow-hidden border border-gray-300 dark:border-gray-600 text-sm">
    ...
    <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-sm mt-4 p-6">
      ...
      <div class="border border-dashed border-gray-300 dark:border-gray-600 rounded-lg p-8 text-center">
        ...
        <!-- 感想を記録する → 感想フォームへ -->
        <a href="{{ route('impressions.edit', $work->id) }}" class="inline-block text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 rounded-lg px-5 py-2.5">
          感想を記録する
        </a>
      </div>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-sm mt-4 p-6">
      <div class="flex items-center justify-between mb-4">
        ...
        <!-- 感想を編集する → 感想フォームへ -->
        <a href="{{ route('impressions.edit', $work->id) }}" class="text-sm font-medium text-blue-600 border border-blue-600 hover:bg-blue-50 dark:hover:bg-gray-700 rounded-lg px-4 py-2">
          感想を編集する
        </a>
      </div>
        ...
        <div class="flex items-center justify-between flex-wrap gap-2">
          <div class="flex items-center gap-2">
            <span class="star-rating">
              <span class="filled">★</span><span class="filled">★</span><span class="filled">★</span><span class="filled">★</span><span class="half"></span>
            </span>
            <span class="text-sm text-gray-500 dark:text-gray-400">4.5（5点満点）</span>
          </div>
        </div>
        <p class="text-sm text-gray-700 dark:text-gray-300 mt-3 leading-relaxed">
          ここに自分が書いた感想メモが表示されます。「このシーンが良かった」「キャラクターの掘り下げが秀逸」など、自由に記録できるエリアです。
        </p>
      </div>
    </div>
